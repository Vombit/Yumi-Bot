...
if (message.guild.id != '400355776717127690') {
	if (!args[0]) {
		const Sembed = new Discord.MessageEmbed()
			...
			.addField(`${lang.help.profile}:`, '``profile``, ``like``')
			.addField(`${lang.help.economy}:`, '``shop``, ``pay``, ``bonus``')
			.addField(`${lang.help.fun}:`, '``8ball``, ``choose``, ``poll``, ``math``')
			.addField(`${lang.help.manage}:`, '``clear``,  ``yumisay``')
			.addField(`${lang.help.utils}:`, '``avatar``, ``random``,  ``userinfo``, ``serverinfo``,  ``degreeCalc``')
